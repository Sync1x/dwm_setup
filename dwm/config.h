...
static const char *fonts[]          = { "Hack:size=10:Spacing=100", "Symbols Nerd Font:size=10" };
static const char dmenufont[]       = "size=11";
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_w,      spawn,          {.v = (const char*[]) { "/home/jlez/.dotfiles/.scripts/wallpaper", NULL } } },
